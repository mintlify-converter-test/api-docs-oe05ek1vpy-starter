---
title: "Service and Custom Domain Deletion"
description: "This document outlines the JSON response structure for deleting a custom domain associated with a service, including success and error messages."
---
serviceId
